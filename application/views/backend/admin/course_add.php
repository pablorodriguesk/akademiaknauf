                                    ...
                                    <div class="tab-pane" id="basic">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                <label class="col-md-2 col-form-label" for="enable_drip_content">Esse é um curso Presencial?</label>
                                                <div class="col-md-10 pt-2">
                                                    <input type="checkbox" name="tipo" value="1" id="tipo" data-switch="primary">
                                                    <label for="tipo" data-on-label="Sim" data-off-label="Nao"></label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-3">
                                                <label class="col-md-2 col-form-label" for="enable_drip_content">Aula particionada (O certificado só será gerado após a conclusão de 100% da aula)</label>
                                                <div class="col-md-10 pt-2">
