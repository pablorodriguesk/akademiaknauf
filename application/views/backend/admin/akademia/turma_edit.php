<?php
$course_details = $this->akademia_model->get_class_by_id($course_id)->row_array();
?>
<!-- start page title -->
<div class="row ">
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <form class="required-form" action="<?php echo site_url('akademia/turma_form/turma_update/' . $course_id); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="hidden" name="id" id="id" class="form-control" value="<?php echo $course_id; ?>" readonly>
                                <input type="number" name="alunos" id="discount_percentage" class="form-control" value="<?php echo $course_details['alunos']; ?>" min="1" max="100">
                                <div class="input-group-append">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="diasdecurso" value="<?php echo $course_details['diasdecurso']; ?>" class="form-control date" id="expiry_date" placeholder="<?php echo get_phrase('days'); ?>"  required>
                        </div> 
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" value="<?php echo $course_details['dataini']; ?>" id="time_class" name = "dataini" placeholder="<?php echo get_phrase('start_day'); ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="expiry_date"><?php echo get_phrase('start_time'); ?><span class="required">*</span></label>
                            <input type="time" name="horaini" class="form-control date" value="<?php echo $course_details['horaini']; ?>" id="expiry_date" placeholder="<?php echo get_phrase('start_time'); ?>"  required>
                        </div>
                        <div class="form-group">
                            <label for="expiry_date"><?php echo get_phrase('closing_day'); ?><span class="required">*</span></label>
                            <input type="date" name="datafim" class="form-control date" value="<?php echo $course_details['datafim']; ?>" id="expiry_date" placeholder="<?php echo get_phrase('closing_day'); ?>"  required>
                        </div>

                        <div class="form-group">
                            <label for="parent"><?php echo get_phrase('Choose_the_in_person_course'); ?></label>
                            <select class="form-control select2" data-toggle="select2" name="curso" id="parent" onchange="checkCategoryType(this.value)">
                                ...
                                <?php foreach ($curso as $cursos) : ?>
                                    ...
                                    <option value="<?= $cursos["id"] ?>" <?php if($cursos["id"] == $course_details['curso'] ){ echo "selected";} ?> ><?= $cursos["title"] ?></option>
                        ...
                        <div class="form-group">
                            <label for="parent"><?php echo get_phrase('Choose_unit'); ?></label>
                            <select class="form-control select2" data-toggle="select2" name="unidade" id="parent" onchange="checkCategoryType(this.value)">
                                ...
                                <?php foreach ($unidade  as $unidades) : ?>
                                    ...
                                    <option value="<?= $unidades["id"] ?>" <?php if($unidades["id"] == $course_details['Unidade'] ){ echo "selected";} ?> ><?= $unidades["lugar"] ?></option>
                        ...
                        <button type="button" class="btn btn-primary" onclick="checkRequiredFields()"><?php echo get_phrase('edit_class'); ?></button>
                    </form>
                </div>
            </div> <!-- end card body-->
        </div> <!-- end card -->
