...
$tipo =  $this->akademia_model->tipo($course_id)->row()->tipo;
if ($tipo == 1) {

    $turmas = $this->akademia_model->turmasAtivas($course_id)->result();
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="courses-details-1st-text">
                        <h1><?php echo $course_details['title']; ?>
                ...
                <div class="course-left-side">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="course-overview" role="tabpanel" aria-labelledby="course-overview-tab">
                            ...
                            <div class="course-description" id="presencial">
                            <h3 class="description-head">Turmas disponiveis </h3>
                            <br>
                            ...
                            <?php foreach ($turmas as $turma) : ?>
                               ...
                               Turma: <?= $turma->turma; ?>
                               <br>
                               Data: <?= (new \DateTimeImmutable($turma->dataini))->format('d/m/Y');?> a <?= (new \DateTimeImmutable($turma->datafim))->format('d/m/Y');?> 
                               <br>
                               Horario: <?= $turma->horaini; ?>
                               <br>
                              <?php $unidades = $this->akademia_model->unidades($turma->Unidade);
                                echo "Unidade: ".$unidades->row('lugar');
                                ?>
...
<div class="button">
                            ...
                            <?php else : ?>
                                <?php if ($course_details['is_free_course'] == 1) : ?>
                                    <a href="<?php echo site_url('home/get_enrolled_to_free_coursep/' . $course_details['id'].'/'.$turma->id); ?>"><?php echo get_phrase('Enroll Now'); ?></a>
                                <?php else : ?>
